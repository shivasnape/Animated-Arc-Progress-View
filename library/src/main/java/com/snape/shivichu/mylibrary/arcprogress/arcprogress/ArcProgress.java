package com.snape.shivichu.mylibrary.arcprogress.arcprogress;
...
import com.snape.shivichu.mylibrary.R;
import com.snape.shivichu.mylibrary.arcprogress.arcprogress.utils.PixelConverter;

import java.text.DecimalFormat;

/**
 * Created by shivichu on 14/11/17.
 */
public class ArcProgress extends View {

    private static final String TAG = "ARC PROGRESS";
    ...
    public ArcProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_text_size = PixelConverter.sp2px(getResources(), 18);
        min_size = (int) PixelConverter.dp2px(getResources(), 100);
        default_text_size = PixelConverter.sp2px(getResources(), 40);
        default_suffix_text_size = PixelConverter.sp2px(getResources(), 15);
        default_suffix_padding = PixelConverter.dp2px(getResources(), 4);
        default_suffix_text = "%";
        default_bottom_text_size = PixelConverter.sp2px(getResources(), 10);
        default_stroke_width = PixelConverter.dp2px(getResources(), 4);
    ...
    public void animateProgressTo(final int start, final int end, int duration, final ProgressAnimationListener listener) {
        ...
        progressBarAnimator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(final Animator animation) {
                ArcProgress.this.setProgress(end);
                if (listener != null)
        ...
        progressBarAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(final ValueAnimator animation) {
                ...
                if (progress != ArcProgress.this.getProgress()) {
                    Log.d(TAG, progress + "");
                    ArcProgress.this.setProgress(progress);
                    if (listener != null)
